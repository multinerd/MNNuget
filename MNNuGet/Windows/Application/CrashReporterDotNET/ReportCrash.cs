...
namespace Multinerd.Windows.Application.CrashReporterDotNET
{
    ...
    public class ReportCrash
    {
        ...
        {
            Exception = exception;
            ApplicationTitle = Process.GetCurrentProcess().ProcessName;
            ...
            else
            {
                ...
                if (fileName != null)
                    ApplicationVersion = FileVersionInfo.GetVersionInfo(fileName).ProductVersion;
            }
            ...
            if (string.IsNullOrEmpty(ToEmail) || string.IsNullOrEmpty(SmtpHost))
                return;
